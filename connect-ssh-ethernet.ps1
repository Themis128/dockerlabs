# SSH Connection Script for Raspberry Pis via Ethernet
# Usage: .\connect-ssh-ethernet.ps1 [pi-number] [username]
...
Write-Host "Connecting to Raspberry Pi via Ethernet" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
