# Telnet Connection Script for Raspberry Pis via Ethernet
# Usage: .\connect-telnet-ethernet.ps1 [pi-number] [port]
...
Write-Host "Connecting to Raspberry Pi via Telnet (Ethernet)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
