...
This project includes HTML linting configuration files to help maintain code
quality and catch common issues.
...
- Allows inline styles (disabled by default in strict mode, but enabled here for
  flexibility)
