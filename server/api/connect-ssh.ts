/**
 * Proxy endpoint for /api/connect-ssh
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      ...
      statusMessage: error.statusMessage || 'Failed to connect via SSH',
      data: error.data || { success: false, error: 'Failed to connect via SSH' },
    })
  }
})
