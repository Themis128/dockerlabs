/**
 * Proxy endpoint for /api/os-images
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      ...
      statusMessage: error.statusMessage || 'Failed to fetch OS images',
      data: error.data || { success: false, error: 'Failed to fetch OS images' },
    })
  }
})
